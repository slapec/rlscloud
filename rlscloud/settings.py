"""
Django settings for rlscloud project.
...
SECRET_KEY = 'a-)0d-3&nlfu#h9ryq+^ozco#!96#p-#)#$j(gs5e%f06!-9z-'
...
MIDDLEWARE_CLASSES = (
    ...
    'rlscloud.middleware.JsonInBodyMiddleware',
...
WSGI_APPLICATION = 'rlscloud.wsgi.application'
